...
struct stack_from_queues* stack_from_queues_create() {
  struct stack_from_queues* stack_from_queues = malloc(sizeof(struct stack_from_queues));
  stack_from_queues->q1 = queue_create();
  stack_from_queues->q2 = queue_create();
  return stack_from_queues;
}
...
int stack_from_queues_isempty(struct stack_from_queues* stack) {
  assert(stack);
  int q1_empty = queue_isempty(stack->q1);
  int q2_empty = queue_isempty(stack->q2);
  return q1_empty && q2_empty;
}
